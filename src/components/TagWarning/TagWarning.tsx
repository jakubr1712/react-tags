...
import { WarningContainer, WarningText, WarningIcon, WarningHeader, ProgressBar, ProgressBarFill } from './TagWarning.styled';
  ...
  return (
    <WarningContainer>
      <WarningHeader style={{ color: getProgressColor() }}>
        {getProgressText()}
        <ProgressBar>
          <ProgressBarFill style={{ width: `${progress}%`, backgroundColor: getProgressColor() }} />
        </ProgressBar>
      </WarningHeader>
      <WarningText >
