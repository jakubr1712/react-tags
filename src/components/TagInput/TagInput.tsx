...
import { InputContainer, Input, TagContainer, TagList, TagItem, CloseButton, SaveButton, SearchIcon, ClearIcon ,CenteredContainer,Card,H3,HeaderContainer,HorizontalLine,Count,Name} from './TagInput.styled';
...
const [isFocusInput, setIsFocusInput] = useState(false);
  ...
  return (
    ...
    <path
        d="M10 2C5.58 2 2 5.58 2 10s3.58 8 8 8c1.64 0 3.16-.53 4.41-1.41L21.59 22 23 20.59l-7.18-7.18C17.47 13.16 18 11.64 18 10c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6z" />
</svg>
        </SearchIcon>
        <Input
        value={input}
